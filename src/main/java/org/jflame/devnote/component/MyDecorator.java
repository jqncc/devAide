 ...
 */
package org.jflame.devnote.component;
 ...
 * @author yucan.zhang
 */
public class MyDecorator extends VBox {
    ...
    /**
     * Create a window decorator for the specified node with the options: - full
...
//            initY = newY;
    ...
    /**
     * this property is used to replace JavaFX maximization with a custom one
     * that prevents hiding windows taskbar when the JFXDecorator is maximized.
     *
    ...
    /**
     * By default this title property is bound to the primaryStage's title
     * property.
     * <p>
    ...
    /**
     * If you want the {@code primaryStage}'s title and the
     * {@code JFXDecorator}'s title to be different, then go ahead and use this
     * method.
     * <p>
     * By default, this title property is bound to the {@code primaryStage}'s
     * title property-so merely setting the {@code primaryStage}'s title, will
     * set the {@code JFXDecorator}'s title.
     *
     */
