...
public class SVGGlyph extends Pane {
    ...
    /**
     * Constructs SVGGlyph node for a specified svg content and color <b>Note:</b> name and glyphId is not needed when
     * creating a single SVG image, they have been used in {@link SVGGlyphLoader} to load icomoon svg font.
     *
    ...
    public SVGGlyph(int glyphId, String name, String svgPathContent, Paint fill) {
        ...
        this.fill.addListener((observable) -> setBackground(
                new Background(new BackgroundFill(getFill() == null ? Color.BLACK : getFill(), null, null))));
     ...
     */
    private StyleableDoubleProperty size = new SimpleStyleableDoubleProperty(StyleableProperties.SIZE, SVGGlyph.this,
            "size", Region.USE_COMPUTED_SIZE) {
