...
public class SQLFormatter implements CodeFormatter {
    ...
    private final Set<String> BEGIN_CLAUSES = new HashSet<String>();
    private final Set<String> END_CLAUSES = new HashSet<String>();
    private final Set<String> LOGICAL = new HashSet<String>();
    private final Set<String> QUANTIFIERS = new HashSet<String>();
    private final Set<String> DML = new HashSet<String>();
    private final Set<String> MISC = new HashSet<String>();
